...
And to give more structure to the plot, I added subtitles for the types of variables, i.e. *Sociodemographic* and *Health Status* (see data preparation)...

Make subtitles bold using `element_markdown()` from [`{ggtext}`](https://wilkelab.org/ggtext/) to format the text in the y-axis labels.
