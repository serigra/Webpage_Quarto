...
date: "2025-06-07"
description: "The post shows how to transform analysis result data into a nicely designed forest plot using `{ggplot2}`, step by step. "
image: cover-png.png
toc: false
format:
  closeread-html:
...
For presenting analysis result data (e.g., odds ratios and confidence intervals with corresponding p-values) in reports or publications, I find figures are far more helpful than tables.
...
d <- model_data() # analysis result data
```
